    ...
    <body>
        ...
        <div class="formUsersDetails">
            ...
            <div class="userDetails">
                ...
                <form action="myProjectsServlet" method="post" enctype="multipart/form-data">
                    <div class="user__details">
                        <div class="input__box">
                            <span class="details">Project Title</span>
                            <input name="projectName" type="text" placeholder="Enter your project title name" required>
                        </div>

                        <div class="input__box">
                            <span class="details">Project Type</span>
                            <input name="projectType" type="text" placeholder="Enter project type" required>
                        </div>
                        
                        <div class="input__box">
                            <span class="details">Project Link</span>
                            <input name="projectLink" type="text" placeholder="Enter project link" required>
                        </div>

                        <div class="input__box">
                            <span class="details">Photo</span>
                            <input name="projectPic" type="file" placeholder="Upload profile picture" required>
                        </div>
