    ...
    <body>
        ...
        <div class="formUsersDetails">
            ...
            <div class="userDetails">
                <div class="title">Resume Photo</div>
                <form action="resumePicServlet" method="post" enctype="multipart/form-data">
                    <div class="user__details">
                        
                        <div class="input__box">
                            <span class="details">Photo</span>
                            <input name="resumePhoto" type="file" placeholder="Upload Resume Photo" required>
                        </div>
