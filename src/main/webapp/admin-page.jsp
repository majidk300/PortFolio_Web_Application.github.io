<%-- 
    Document   : admin-page
    Created on : Nov 24, 2023, 3:21:28 PM
    Author     : Majid
--%>
    ...
    <body>
        ...
        <div class="formUsersDetails">
            ...
            <div class="userDetails">
                <div class="title">PortFolio Details</div>
                <form action="UpdateUserDetails" method="post" enctype="multipart/form-data">
                    <div class="user__details">
                        ...
                        <div class="input__box">
                            ...
                            <input name="email" type="email" placeholder="demo123@.com" required>
                        </div>
                        <div class="input__box">
                            <span class="details">Phone Number</span>
                            <input name="phone" type="text"  placeholder="012-345-6789" required>
                        </div>
                        <div class="input__box">
                            <span class="details">Profession</span>
                            <input name="profession" type="text" placeholder="Developer ?" required>
                        </div>
                        <div class="input__box">
                            <span class="details">Facebook link</span>
                            <input name="facebook" type="text" placeholder="link" required>
                        </div>

                        <div class="input__box">
                            <span class="details">Instagram link</span>
                            <input name="instagram" type="text" placeholder="link" required>
                        </div>

                        <div class="input__box">
                            <span class="details">Lindin link</span>
                            <input name="linkdin" type="text" placeholder="link" required>
                        </div>

                        <div class="input__box">
                            <span class="details">Photo</span>
                            <input name="photo" type="file" placeholder="profile picture" required>
                        </div>

                        <div class="input__box">
                            <span class="details">About you</span>

                            <textarea name="about"  class="textarea" name="bio" style="width:100%; height:150px;  padding:5px; outline:none;" required></textarea>
                        </div>
